...
# This repository IS the kit, so its foundation lives under core/ rather than at the root.
REVIEW_DOCS="${REVIEW_DOCS:-core/AGENTS.md, core/docs/ARCHITECTURE.md, core/docs/REVIEW_GATE.md and CONTRIBUTING.md}"
